...
*---------------------------------------------------------------*
CLAYX = 0.36, 0.37, 0.37      !soil clay content, fraction
SANDX = 0.35, 0.33, 0.29      !soil sand content, fraction
BD = 1.36, 1.62, 1.58     !soil bulk density (g/cm3)

*Soil organic carbon and nitrogen content in kg C or N/ha
SOC = 46619., 29332., 22781.   ! Soil organic C (kg C/ha)
SON = 3618., 2297., 2414.        ! Soil organic N (kg N/ha) 

SNH4X = 44.1, 47.3, 53.20     !*soil NH4-N (kg N/ha)
SNO3X = 45.6, 25.0, 4.93 !*soil NO3-N (kg N/ha)
