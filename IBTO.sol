...
*---------------------------------------------------------------*
CLAYX = 0.13, 0.13, 0.13      !soil clay content, fraction
SANDX = 0.41, 0.48, 0.78      !soil sand content, fraction
BD = 1.79, 1.76, 1.59     !soil bulk density (g/cm3)

*Soil organic carbon and nitrogen content in kg C or N/ha
SOC = 16119., 8465., 4448.   ! Soil organic C (kg C/ha)
SON = 2486., 1043., 597.        ! Soil organic N (kg N/ha) 

SNH4X = 11.2, 7.0, 6.8     !*soil NH4-N (kg N/ha)
SNO3X = 10.7, 8.2, 31.8 !*soil NO3-N (kg N/ha)
